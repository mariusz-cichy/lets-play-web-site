...
VALUES (1, 'Czy jesteś zadowolony z asortymentu choinek świątecznych oferowanych przez Lets Play?',
        PARSEDATETIME('2018-01-01 00:00:00', 'yyyy-MM-dd HH:mm:ss'), PARSEDATETIME('2018-01-31 23:59:59', 'yyyy-MM-dd HH:mm:ss'));
INSERT INTO pools(id, question, start_date, end_date)
VALUES (2, 'Jakim prezent dałbyś najważniejszej dla Ciebie osobie z okazji urodzin?',
        PARSEDATETIME('2018-02-01 00:00:00', 'yyyy-MM-dd HH:mm:ss'), PARSEDATETIME('2018-02-28 23:59:59', 'yyyy-MM-dd HH:mm:ss'));
INSERT INTO pools(id, question, start_date, end_date)
VALUES (3, 'Jaki jest Twój ulubiony kolor?',
        PARSEDATETIME('2018-03-01 00:00:00', 'yyyy-MM-dd HH:mm:ss'), PARSEDATETIME('2018-03-31 23:59:59', 'yyyy-MM-dd HH:mm:ss'));
INSERT INTO pools(id, question, start_date, end_date)
VALUES (4, 'Z jakiej okazji ubrałabyś się w sukienkę z balonów?',
        PARSEDATETIME('2018-04-01 00:00:00', 'yyyy-MM-dd HH:mm:ss'), PARSEDATETIME('2018-04-30 23:59:59', 'yyyy-MM-dd HH:mm:ss'));
INSERT INTO pools(id, question, start_date, end_date)
VALUES (5, 'Jakie jest Twoje ulubione święto?',
        PARSEDATETIME('2018-05-01 00:00:00', 'yyyy-MM-dd HH:mm:ss'), PARSEDATETIME('2018-05-31 23:59:59', 'yyyy-MM-dd HH:mm:ss'));
INSERT INTO pools(id, question, start_date, end_date)
VALUES (6, 'Jakie informacje chiałbyś zobaczyć na naszej stronie internetowej?',
        PARSEDATETIME('2018-06-01 00:00:00', 'yyyy-MM-dd HH:mm:ss'), PARSEDATETIME('2018-06-30 23:59:59', 'yyyy-MM-dd HH:mm:ss'));
INSERT INTO pools(id, question, start_date, end_date)
VALUES (7, 'Jak Ci się podoba nasza strona internetowa?',
        PARSEDATETIME('2019-01-01 00:00:00', 'yyyy-MM-dd HH:mm:ss'), NULL);
...
VALUES (1, FILE_READ('src/test/resources/test-data/images/movado-watch-300x300.jpg'), 'Rocznica ślubu', 'Zegarek Movado', 'Womans Movado Red Label automatic watch',
'Womens Red Label automatic watch, 26 mm rose gold PVD-finished stainless steel case with exhibition back, black Museum dial with rose gold-toned dot and hands, and red lettering, rose gold PVD-finished stainless steel link bracelet with push-button deployment clasp.',
        200.00, NULL, 5, NULL);

INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (2, FILE_READ('src/test/resources/test-data/images/titan-watch-300x300.jpg'), 'Rocznica ślubu', 'Zegarek Titan', 'Piękny zegarek firmy Titan.',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (3, FILE_READ('src/test/resources/test-data/images/golden-ring-300x300.jpg'), 'Rocznica ślubu', 'Pierścionek z diamentem', '18 karatowy złoty pierścionek z diamentem.',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (4, FILE_READ('src/test/resources/test-data/images/couple-rings-300x300.jpg'), 'Rocznica ślubu', 'Pierścionek dla niej i dla niego', 'Doskonały prezent z okazji rocznicy ślubu',
        'A gorgeous 18k gold diamond ring for her and a simple 18k gold ring for him. To doskonały prezent z okazji Rocznica ślubu.',
        1000.00, NULL, 5, NULL);

INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (5, FILE_READ('src/test/resources/test-data/images/iphonex-black-300x300.jpg'), 'Urodziny', 'iPhone X', 'Telefon Apple iPhone X Czarny 256GB',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (6, FILE_READ('src/test/resources/test-data/images/birthday-cake-300x300.jpg'), 'Urodziny', 'Tort urodzinowy', 'Wiggles Birthday cake to make your kid feel special',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (7, FILE_READ('src/test/resources/test-data/images/birthday-flowers-vase-300x300.jpg'), 'Urodziny', 'Bukiet kwiatów i wazon', 'Surprise your loved ones with flowers',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (8, FILE_READ('src/test/resources/test-data/images/christmas-tree-300x300.jpg'), 'Boże Narodzenie', 'Choinka świąteczna', 'Delux quality Christmas Tree for home or office',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (9, FILE_READ('src/test/resources/test-data/images/multiple-christmas-trees.jpg'), 'Boże Narodzenie', 'Zestaw choinek świątecznych', 'Delux quality Christmas Trees for home or office',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (10, FILE_READ('src/test/resources/test-data/images/christmas-decoration-folk-300x300.jpg'), 'Boże Narodzenie', 'Bombki kaszubskie', 'Silver Jewel Ball Decoration for your Christmas tree',
        'Silver acrylic ball with diamontes and silver glitter hand painted decoration. Size: 80mm diameter',
        10.00, 2.00, 5, 3);

INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (11, FILE_READ('src/test/resources/test-data/images/christmas-candles-300x300.jpg'), 'Boże Narodzenie', 'Świece świąteczne', 'Silver & Blue Ball Decoration for your Christmas tree',
        'Silver & Blue acrylic ball with diamontes and colored glitter hand painted decoration. Size: 80mm diameter',
        10.00, 2.00, 5, 3);

INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (12, FILE_READ('src/test/resources/test-data/images/compendium-300x300.jpg'), 'Impreza firmowa', 'Organizator', 'Diary/Organizer/Compendium for office use',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (13, FILE_READ('src/test/resources/test-data/images/mouse-pad-300x300.jpg'), 'Impreza firmowa', 'Podkładka pod myszkę', 'Basic Mouse Pad',
...
INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (14, FILE_READ('src/test/resources/test-data/images/mug-300x300.jpg'), 'Impreza firmowa', 'Kubek', 'Classic Coffee Mug',
        'Perfect for home or office, the coffee mug is microwave and dishwasher safe.',
        50.00, 1.00, 5, 3);

INSERT INTO items (id, image, celebration, name, description, details, buy, hire, stock_buy, stock_hire)
VALUES (15, FILE_READ('src/test/resources/test-data/images/pen-300x300.jpg'), 'Impreza firmowa', 'Pióro', 'Classic Pen',
